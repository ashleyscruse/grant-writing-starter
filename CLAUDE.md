...
- `profile/` — **the researcher's reusable context.** The knowledge base every skill reads, the same for every grant. Blank until filled; the setup guide helps fill it. Three parts:
  ...
  - `alignment/` — strategic context to align proposals with: the institution's strategic plan and the funder's / federal priorities. Read it when judging strategic value and when framing a draft.
