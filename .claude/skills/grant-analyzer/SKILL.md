...
- `profile/me/profile.md` -- positions, education, skills
- `profile/me/profile.md` -- research focus, publications, active agenda
- `profile/me/profile.md` -- mentoring track record, programs, curricula
- `profile/me/profile.md` -- past grants, strengths, known gaps
