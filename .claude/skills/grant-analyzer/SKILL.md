...
- `alignment.md` -- the institution's strategic plan and the funder's / federal priorities to align with
...
- Does it align with the institution's strategic plan and the funder's stated priorities (see `profile/alignment.md`)?
